    ...
    <div class="con_header">
		...
		<div class="open_menu">
            <div class="box_info">
                <ul class="box_menu">
                    <li>
                        <a href="<?=DIR?>/vivus/brand">
                            <span class="tit_en">ABOUT</span>
                            <small>ビーバースとは</small>
                        </a>
                    </li>
                    <li>
                        <a href="<?=DIR?>/vivus/products/">
                            <span class="tit_en">PRODUCTS</span>
                            <small>商品</small>
                        </a>
                    </li>
                    <li>
                        <a href="<?=DIR?>/vivus/shop/">
                            <span class="tit_en">SHOP LIST</span>
                            <small>パートナーショップ</small>
                        </a>
                    </li>
                    <li>
                        <a href="<?=DIR?>/vivus/contact">
                            <span class="tit_en">CONTACT</span>
                            <small>お問い合わせ</small>
                        </a>
                    </li>
                </ul>
